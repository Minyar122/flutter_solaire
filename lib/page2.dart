        ...
        children: [
          ...
          Center(
            child: Container(
              ...
              child: Center(
                child: Text(
                  'الأرض هي الكوكب الذي نعيش عليه. هي ثالث كوكب من الشمس، وتدور حولها في مدار. تستغرق الأرض حوالي سنة كاملة (365 يومًا) لإكمال دورتها حول الشمس. تدور الأرض أيضًا حول نفسها، مما يجعل هناك نهارًا وليلًا. الأرض تحتوي على ماء وهواء، وهذا يجعلها المكان الوحيد الذي توجد فيه الحياة.',
                  style: TextStyle(
                    fontSize: 14,
