        ...
        children: [
          ...
          Center(
            child: Container(
              ...
              child: Center(
                child: Text(
                  'عطارد هو أقرب كوكب إلى الشمس. هو صغير جدًا ولا يوجد لديه جو يحميه من الحرارة أو البرد. يصبح حارًا جدًا في النهار وباردًا جدًا في الليل. يدور عطارد ببطء حول نفسه ويستغرق 59 يومًا للقيام بذلك. ليس لديه أي أقمار.',
                  style: TextStyle(
                    fontSize: 14,
